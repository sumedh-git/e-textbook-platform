...
function FacultyModifyContentBlock() {
        ...
        <Container className="d-flex justify-content-center align-items-center" style={{ minHeight: "100vh" }}>
            <Card style={{ width: '400px' }} className="p-4">
                ...
                <ListGroup className="mt-3">
                    <ListGroup.Item action onClick={() => handleMenuAction("HideContentBlock")}>
                        1. Hide Content Block
                    </ListGroup.Item>
                    <ListGroup.Item action onClick={() => handleMenuAction("DeleteContentBlock")}>
                    ...
                    <ListGroup.Item action onClick={() => handleMenuAction("DeleteActivity")}>
                        6. Delete Activity
                    </ListGroup.Item>
