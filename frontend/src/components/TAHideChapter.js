  ...
  const handleSave = async () => {
    try {
      const response = await fetch(
        "http://localhost:5000/api/ta/hide-chapter",
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      <Card style={{ width: "400px" }} className="p-4">
        ...
        <Button variant="primary" onClick={handleSave} className="w-100 mt-3">
          Save
        </Button>
        <Button
          variant="secondary"
